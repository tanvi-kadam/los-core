...
exports.IntegrationModule = IntegrationModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([entity_snapshot_entity_1.EntitySnapshot]),
            application_module_1.ApplicationModule,
        ],
        controllers: [integration_controller_1.IntegrationController],
        providers: [entity_snapshot_repository_1.EntitySnapshotRepository, integration_service_1.IntegrationService],
