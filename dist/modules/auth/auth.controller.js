...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login successful', schema: { example: { status: 'SUCCESS', data: { access_token: 'eyJ...', refresh_token: 'eyJ...', expires_in: 900 }, correlation_id: '' } } }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Current user', schema: { example: { status: 'SUCCESS', data: { user_id: '', email: '', role_id: '' }, correlation_id: '' } } }),
