...
exports.DuplicateCheckRepository = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const duplicate_check_entity_1 = require("../entities/duplicate-check.entity");
let DuplicateCheckRepository = class DuplicateCheckRepository {
    constructor(repo) {
        this.repo = repo;
    }
    async save(entity) {
...
exports.DuplicateCheckRepository = DuplicateCheckRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(duplicate_check_entity_1.DuplicateCheck)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], DuplicateCheckRepository);
//# sourceMappingURL=duplicate-check.repository.js.map