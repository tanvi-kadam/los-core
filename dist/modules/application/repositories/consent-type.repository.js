...
exports.ConsentTypeRepository = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const consent_type_entity_1 = require("../entities/consent-type.entity");
let ConsentTypeRepository = class ConsentTypeRepository {
    constructor(repo) {
        this.repo = repo;
    }
    async findById(id) {
...
exports.ConsentTypeRepository = ConsentTypeRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(consent_type_entity_1.ConsentType)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ConsentTypeRepository);
//# sourceMappingURL=consent-type.repository.js.map